...
const SCHEDULE_SCANNER_SYSTEM_PROMPT = `Extract ALL schedule rows into JSON. Output ONLY raw JSON, no prose, no markdown, no fences.
{"classes":[{"subject":"Math","room":"TBA","day":"MONDAY","startTime":"09:00","endTime":"10:30"}],"uncertainFields":[]}
Day codes: M=Mon T=Tue W=Wed Th=Thu F=Fri S=Sat U=Sun. MWF=Mon+Wed+Fri, TTh=Tue+Thu, MW=Mon+Wed. Add 1hr if end missing. Include every row in the table. None: {"classes":[],"uncertainFields":["all"]}`.trim();
